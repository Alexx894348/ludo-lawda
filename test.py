...
class Ludo:
    ...
    def take_initial_control(self):
        ...
        top.iconbitmap("Images/ludo_icon.png")
...
if __name__ == '__main__':
    ...
    window.iconbitmap("Images/ludo_icon.png")
    block_six_side = ImageTk.PhotoImage(Image.open("Images/6_block.jpeg").resize((33, 33), Image.LANCZOS))
    block_five_side = ImageTk.PhotoImage(Image.open("Images/5_block.jpeg").resize((33, 33), Image.LANCZOS))
    block_four_side = ImageTk.PhotoImage(Image.open("Images/4_block.jpeg").resize((33, 33), Image.LANCZOS))
    block_three_side = ImageTk.PhotoImage(Image.open("Images/3_block.jpeg").resize((33, 33), Image.LANCZOS))
    block_two_side = ImageTk.PhotoImage(Image.open("Images/2_block.jpeg").resize((33, 33), Image.LANCZOS))
    block_one_side = ImageTk.PhotoImage(Image.open("Images/1_block.jpeg").resize((33, 33), Image.LANCZOS))
